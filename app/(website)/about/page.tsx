    ...
    <div className="flex flex-col bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-screen selection:bg-amber-600 selection:text-white font-sans transition-colors duration-500 pt-10 md:pt-24">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto w-full border-t border-zinc-200 dark:border-zinc-900 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Past Card */}
          <ScrollReveal direction="down" delay={0.1} className="flex flex-col h-full">
            <div className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-900 p-8 md:p-12 rounded-3xl shadow-sm hover:shadow-lg dark:hover:shadow-none hover:border-zinc-300 dark:hover:border-zinc-800 transition-all duration-500 group flex flex-col justify-between h-full">
              <div>
